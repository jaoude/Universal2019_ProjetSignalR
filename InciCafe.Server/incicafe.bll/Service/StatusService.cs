...
namespace InciCafe.BLL.Service
{
    ...
    {
        public StatusService(IUnitOfWork uow, IAutoMapperService mapper, ILogger<StatusService> logger) : base(uow, mapper, logger)
        {

        }

        async Task<StatusDto> IStatusService.GetStatusAsync(int id, CancellationToken ct)
        {
